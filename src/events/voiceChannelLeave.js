...
function voiceChannelLeave(client) {
    client.on('voiceChannelLeave', (member, channel, user) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (!configs.pointVoiceChannelsId.includes(channel.id))
            return;
        if (!(user === null || user === void 0 ? void 0 : user.startedWorkAt))
            return;
        const timeWorked = Date.now() - new Date(user.startedWorkAt).getTime();
        const mainEmbed = (0, responseEmbeds_1.memberLeftVoiceChannel)(channel.guild, member, timeWorked);
...
//# sourceMappingURL=voiceChannelLeave.js.map