...
function closePointButtonClicked(client) {
    client.on('closePointButtonClicked', (interaction, user) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (!(user === null || user === void 0 ? void 0 : user.startedWorkAt)) {
            const errorEmbed = (0, responseEmbeds_1.notHaveOpenPoint)(interaction.guild);
            interaction.reply({
                embeds: [errorEmbed],
                ephemeral: true
            });
        ...
        const timeWorked = Date.now() - new Date(user.startedWorkAt).getTime();
        UsersRepository_1.usersRepository.update(interaction.user.id, (user) => {
            user.pointHours += timeWorked;
            user.startedWorkAt = null;
        });
        const mainEmbed = (0, responseEmbeds_1.pointWasClosed)(interaction.guild, member, timeWorked);
        const logMessage = yield logChannel.send({
            content: member.toString(),
            embeds: [mainEmbed]
        });
        const interactionResponse = (0, responseEmbeds_1.pointClosedResponse)(interaction.guild, logMessage);
...
exports.default = closePointButtonClicked;
//# sourceMappingURL=closePointButtonClicked.js.map